    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="", max_length=32, verbose_name="Nombre"),
                ),
                (
                    "desc",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_name",
                    models.CharField(max_length=32, verbose_name="Apellido paterno"),
                ),
                (
                    "maternal_last_name",
                    models.CharField(max_length=32, verbose_name="Apellido materno"),
                ),
                (
                    "rfc",
                    models.CharField(max_length=13, unique=True, verbose_name="R.F.C."),
                ),
                (
                    "email",
                    models.CharField(max_length=32, verbose_name="Correo eléctronico"),
                ),
                ...
                (
                    "phone",
                    models.CharField(max_length=10, verbose_name="Número de teléfono"),
                ),
                (
                    "clabe",
                    models.CharField(max_length=32, verbose_name="CLABE bancaria"),
                ),
